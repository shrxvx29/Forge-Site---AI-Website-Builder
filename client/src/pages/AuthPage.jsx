    ...
    <div className="min-h-screen bg-white flex text-zinc-900 font-sans">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        <form className='space-y-6' onSubmit={handleSubmit}>
          ...
          className='w-full py-2.5 bg-linear-to-br from-blue-900 to-blue-400 text-white font-semibold hover:scale-102 disabled:opacity-40 flex items-center justify-center cursor-pointer mt-2 rounded-lg transition-all'>
